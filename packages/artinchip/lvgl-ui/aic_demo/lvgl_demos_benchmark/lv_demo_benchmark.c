...
static void img_rgb_cb(void)
{
	...
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_rgb.png), false, false, false);
#else    
...
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_argb.png), false, false, false);
#else
#if LV_DEMO_BENCHMARK_RGB565A8 && LV_COLOR_DEPTH == 16
...
static void img_ckey_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_chroma_keyed.png), false, false, false);
#else    
...
static void img_index_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_indexed16.png), false, false, false);
#else    
...
static void img_alpha_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
    img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_alpha16.png), false, false, false);
#else    
...
static void img_rgb_rot_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_rgb.png), true, false, false);
#else 
...
static void img_rgb_rot_aa_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_rgb.png), true, false, true);
#else    
...
static void img_argb_rot_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_argb.png), true, false, false);
#else        
#if LV_DEMO_BENCHMARK_RGB565A8 && LV_COLOR_DEPTH == 16
...
static void img_argb_rot_aa_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_argb.png), true, false, true);
#else        
#if LV_DEMO_BENCHMARK_RGB565A8 && LV_COLOR_DEPTH == 16
...
static void img_rgb_zoom_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_rgb.png), false, true, false);
#else        
...
static void img_rgb_zoom_aa_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
    img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_rgb.png), false, true, true);
#else        
...
static void img_argb_zoom_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_argb.png), false, true, false);
#else        
#if LV_DEMO_BENCHMARK_RGB565A8 && LV_COLOR_DEPTH == 16
...
static void img_argb_zoom_aa_cb(void)
{
    ...
    lv_style_set_img_opa(&style_common, opa_mode ? LV_OPA_50 : LV_OPA_COVER);
#if HAVE_BENCHMARK_PNG
	img_create(&style_common, LVGL_PATH(img_benchmark_cogwheel_argb.png), false, true, true);
#else        
#if LV_DEMO_BENCHMARK_RGB565A8 && LV_COLOR_DEPTH == 16
