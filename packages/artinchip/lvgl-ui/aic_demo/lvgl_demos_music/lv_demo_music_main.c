...
lv_obj_t * _lv_demo_music_main_create(lv_obj_t * parent)
{
	...
	lv_obj_set_grid_cell(title_box, LV_GRID_ALIGN_STRETCH, 0, 1, (lv_grid_align_t)LV_ALIGN_CENTER, 2, 1);
	lv_obj_set_grid_cell(icon_box, LV_GRID_ALIGN_STRETCH, 0, 1, (lv_grid_align_t)LV_ALIGN_CENTER, 4, 1);
	lv_obj_set_grid_cell(ctrl_box, LV_GRID_ALIGN_STRETCH, 0, 1, (lv_grid_align_t)LV_ALIGN_CENTER, 6, 1);
	lv_obj_set_grid_cell(handle_box, LV_GRID_ALIGN_STRETCH, 0, 1, (lv_grid_align_t)LV_ALIGN_CENTER, 8, 1);
...
#if HAVE_MUSIC_MAIN_001_0001
    LV_IMG_DECLARE(img_lv_demo_music_logo); // this make memory overfow
    LV_IMG_DECLARE(img_lv_demo_music_icon_4);
#endif
    lv_obj_t * logo = lv_img_create(lv_scr_act());
#if HAVE_MUSIC_MAIN_001_0001
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(logo, LVGL_PATH(img_lv_demo_music_logo.png));
#else
    lv_img_set_src(logo, &img_lv_demo_music_logo);
    //lv_img_set_src(logo, &img_lv_demo_music_icon_4);
    //const uint8_t * aaa = img_lv_demo_music_logo.data;
    //kkk = aaa[0];
    //const uint8_t * bbb = img_lv_demo_music_icon_4.data;
    //kkk = bbb[0];
#endif
#endif
...
#if HAVE_MUSIC_MAIN_001_001
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(wave_top, LVGL_PATH(img_lv_demo_music_wave_top.png));
#else
...
#if HAVE_MUSIC_MAIN_001_001
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(wave_bottom, LVGL_PATH(img_lv_demo_music_wave_bottom.png));
#else
...
#if HAVE_MUSIC_MAIN_001_002
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(wave_corner, LVGL_PATH(img_lv_demo_music_corner_left.png));
#else
...
#if HAVE_MUSIC_MAIN_002
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(wave_corner, LVGL_PATH(img_lv_demo_music_corner_right.png));
#else
...
#if HAVE_MUSIC_MAIN_001_002
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_icon_1.png));
#else
...
#if HAVE_MUSIC_MAIN_001_002
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_icon_2.png));
#else
...
#if HAVE_MUSIC_MAIN_001_002
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_icon_3.png));
#else
...
#if HAVE_MUSIC_MAIN_001_002
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_icon_4.png));
#else
...
#if HAVE_MUSIC_MAIN_001_003
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_btn_rnd.png));
#else
...
#if HAVE_MUSIC_MAIN_001_003
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_btn_loop.png));
#else
...
#if HAVE_MUSIC_MAIN_001_003
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_btn_prev.png));
#else
...
#if HAVE_MUSIC_MAIN_001_003
#if HAVE_MUSIC_MAIN_PNG
    lv_imgbtn_set_src(play_obj, LV_IMGBTN_STATE_RELEASED, NULL, LVGL_PATH(img_lv_demo_music_btn_play.png), NULL);
    lv_imgbtn_set_src(play_obj, LV_IMGBTN_STATE_CHECKED_RELEASED, NULL, LVGL_PATH(img_lv_demo_music_btn_pause.png), NULL);
#else
...
#else
	lv_obj_set_width(play_obj, 141);
#endif

    icon = lv_img_create(cont);
#if HAVE_MUSIC_MAIN_001_003
#if HAVE_MUSIC_MAIN_PNG
	lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_btn_next.png));
#else
...
#if HAVE_MUSIC_MAIN_001_003
#if HAVE_MUSIC_MAIN_PNG
    lv_obj_set_style_bg_img_src(slider_obj, LVGL_PATH(img_lv_demo_music_slider_knob.png), LV_PART_KNOB);
#else
...
#if HAVE_MUSIC_MAIN_001_004
#if HAVE_MUSIC_MAIN_PNG
			lv_img_set_src(img, LVGL_PATH(img_lv_demo_music_cover_3.png));
#else
...
#if HAVE_MUSIC_MAIN_001_004
#if HAVE_MUSIC_MAIN_PNG
			lv_img_set_src(img, LVGL_PATH(img_lv_demo_music_cover_2.png));
#else
...
#if HAVE_MUSIC_MAIN_001_004
#if HAVE_MUSIC_MAIN_PNG
			lv_img_set_src(img, LVGL_PATH(img_lv_demo_music_cover_1.png));
#else
