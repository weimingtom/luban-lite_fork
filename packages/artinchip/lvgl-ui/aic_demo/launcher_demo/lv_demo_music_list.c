...
#if HAVE_MUSIC_LIST_PNG
        lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_btn_list_pause.png));
#else        
...
#if HAVE_MUSIC_LIST_PNG
        lv_img_set_src(icon, LVGL_PATH(img_lv_demo_music_btn_list_play.png));
#else      
...
#if HAVE_MUSIC_LIST_PNG
    lv_img_set_src(border, LVGL_PATH(img_lv_demo_music_list_border.png));
#else       
