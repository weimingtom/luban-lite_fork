...
#if HAVE_WIDGETS_PNG
		lv_img_set_src(logo, LVGL_PATH(img_lvgl_logo.png));
#else        
...
#if HAVE_WIDGETS_PNG
	lv_img_set_src(avatar, LVGL_PATH(img_demo_widgets_avatar.png));
#else        
...
#if HAVE_WIDGETS_PNG
    create_shop_item(list, LVGL_PATH(img_clothes.png), "Blue jeans", "Clothes", "$722");
    create_shop_item(list, LVGL_PATH(img_clothes.png), "Blue jeans", "Clothes", "$411");
    create_shop_item(list, LVGL_PATH(img_clothes.png), "Blue jeans", "Clothes", "$917");
    create_shop_item(list, LVGL_PATH(img_clothes.png), "Blue jeans", "Clothes", "$64");
    create_shop_item(list, LVGL_PATH(img_clothes.png), "Blue jeans", "Clothes", "$805");		
#else        
