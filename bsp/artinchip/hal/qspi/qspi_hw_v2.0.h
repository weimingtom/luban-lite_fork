...
#define FCTL_BIT_GPDMA_WORD_EN          (1UL << 11)
#endif
...
#ifdef AIC_DMA_DRV_V20
#define ISTS_BIT_GPDMA_RX_DONE          BIT(24)
#define ISTS_BIT_GPDMA_TX_DONE          BIT(25)
#endif
...
#ifdef AIC_DMA_DRV_V20
static inline bool qspi_hw_check_gpdma_tx_done(u32 base)
{
    u32 val = readl(QSPI_REG_ISTS(base));
    return ((val & ISTS_BIT_GPDMA_TX_DONE) != 0);
}

static inline bool qspi_hw_check_gpdma_rx_done(u32 base)
{
    u32 val = readl(QSPI_REG_ISTS(base));
    return ((val & ISTS_BIT_GPDMA_RX_DONE) != 0);
}
#endif
